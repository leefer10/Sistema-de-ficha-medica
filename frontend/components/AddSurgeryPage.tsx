...
interface AddSurgeryPageProps {
  onNavigate?: (path: string) => void;
}

export function AddSurgeryPage({ onNavigate }: AddSurgeryPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await ApiClient.addSurgery(userId, payload);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold">Agregar Cirugía</h1>
            <p className="text-muted-foreground">Registra una nueva cirugía en tu ficha médica</p>
          </div>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-800">Cirugía guardada correctamente. Redirigiendo...</p>
            </div>
          </div>
        )}
